  ...
  render () {
    return (
      <Button color={ this.props.color } onClick={ this.props.action } style={{ minWidth: '100%', marginBottom: '.5rem' }}>
        <i className={ "float-xs-left fa fa-" + this.props.icon }  aria-hidden="true" style={{ padding: '.3rem .8rem .3rem 0rem', borderRight: '1px solid', marginRight: '0.8rem', minWidth: '2rem'}}></i>
